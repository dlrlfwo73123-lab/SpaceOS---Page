  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={onClose}>
      ...
      >
        ...
        <p className="mb-3 text-xs text-slate-400">최근 36개월(오늘 기준 3년 전부터) + 다음 달 AI 예측 1개월</p>
        ...
        <Plot
          data={[
            ...
            ...(selected ? [{
              ...
              name: '선택값',
              marker: { color: '#16a34a', size: 13, symbol: 'circle-open', line: { width: 3, color: '#16a34a' } },
              showlegend: false,
        ...
        <div className="mt-3 max-h-32 overflow-y-auto rounded-lg border border-slate-100">
          <div className="grid grid-cols-4 gap-1 p-2 sm:grid-cols-6">
            {points.map((p) => (
              ...
              >
                <span className="block text-[10px] text-slate-400">{p.month}{p.predicted ? ' (예측)' : ''}</span>
